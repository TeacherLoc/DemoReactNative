...
const FALLBACK_FOODS = {
  1: [
    // cuisineId '1' (Chinese)
    {
      ...
      description: 'Vịt đem đi quay.',
      price: '120',
      imageUrl:
        'https://ongvove.com/uploads/0000/17/2024/08/22/nguon-goc-va-lich-su-cua-vit-quay-bac-kinh.jpg',
      cuisineId: '1',
    },
    {
      id: 'f2',
  ...
  2: [
    ...
    {
      id: 'f3',
      name: 'Cơm trộn rau củ',
      description: 'Không sử dụng thịt, hoàn toàn tự nhiên (đồ chay).',
      price: '220',
      imageUrl:
        'https://file.hstatic.net/1000312435/file/an-do-khong-an-thit-lon-bo_86a6f1c1d67848a0a8f286cc7fd5c907_grande.jpeg',
      cuisineId: '2',
    },
    {
      id: 'f4',
      name: 'Masala Dosa',
      description: 'Cơm cùng với nhiều món ăn kèm rất đặc trưng của văn hoá Ấn.',
      price: '130',
      imageUrl:
        'https://file.hstatic.net/1000312435/file/mon-an-an-do_8b97b6ce09e8446fb777f2462e4cd858_grande.jpeg',
      cuisineId: '2',
    },
  ],
  3: [
    // cuisineId '3' (Beverages)
    {
      id: 'f5',
      name: 'Cà phê sữa đá',
      description: 'Món thức uống dành cho người Việt Nam.',
      price: '80',
      imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Viet-coffee.jpg/500px-Viet-coffee.jpg',
      cuisineId: '3',
    },
    {
      id: 'f6',
