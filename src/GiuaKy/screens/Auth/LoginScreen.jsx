...
const LoginScreen = ({navigation}) => {
  ...
  return (
    <View
      ...
      <Text style={[styles.title, {color: theme.colors.primary}]}>Restaurant App</Text>
      <TextInput
        label="Email"
        value={email}
        onChangeText={text => {
      ...
      <TouchableOpacity
        ...
        <Text style={[styles.linkText, {color: theme.colors.tertiary}]}>
          Quên mật khẩu?
        </Text>
      </TouchableOpacity>
      ...
      <Button
        ...
        style={[styles.button, styles.signUpButton, {borderColor: theme.colors.secondary}]}
